...
const messages = {
  en: {
    ...
    message: {
      ...
      snapshotfail: "Failed to load world snapshot: {err}",
      snapshotdownloadsuccess: "World snapshot downloaded.",
      shutdowninvalid: "Shutdown delay must be a positive whole number.",
    ...
    button: {
      ...
      serverSettings: "Server Settings",
      worldSnapshot: "World Snapshot",
      downloadSnapshot: "Download JSON",
    ...
    item: {
      ...
      actorAction: "Current Action",
      actorLocation: "Location (X, Y, Z)",
    ...
    input: {
      ...
      shutdownSeconds: "Shutdown delay (seconds)",
      shutdownMessage: "Announcement message",
      shutdownMessagePlaceholder: "Optional message shown before shutdown",
    },
    map: {
  ...
  zh: {
    ...
    message: {
      ...
      snapshotfail: "读取世界快照失败: {err}",
      snapshotdownloadsuccess: "世界快照已下载。",
      shutdowninvalid: "关服等待时间必须为正整数。",
    ...
    input: {
      ...
      selectItem: "选择物品",
      selectPal: "选择帕鲁",
      shutdownSeconds: "关服等待时间（秒）",
      shutdownMessage: "关服公告",
      shutdownMessagePlaceholder: "可选：关服前向玩家显示的消息",
    },
    map: {
  ...
  ja: {
    ...
    message: {
      ...
      snapshotfail: "ワールドスナップショットの取得に失敗しました: {err}",
      snapshotdownloadsuccess:
        "ワールドスナップショットをダウンロードしました。",
      shutdowninvalid: "シャットダウン待機時間は正の整数で指定してください。",
    ...
    item: {
      ...
      actorType: "アクター種別",
      actorName: "アクター名",
      actorAction: "現在のアクション",
      actorLocation: "座標 (X, Y, Z)",
    ...
    input: {
      ...
      selectItem: "アイテムを選択",
      selectPal: "パルを選択",
      shutdownSeconds: "シャットダウン待機時間（秒）",
      shutdownMessage: "告知メッセージ",
      shutdownMessagePlaceholder: "任意：シャットダウン前に表示するメッセージ",
    },
    pal: {
      type: "タイプ",
      level: "レベル",
